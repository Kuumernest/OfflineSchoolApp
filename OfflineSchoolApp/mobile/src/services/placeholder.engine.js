...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * PLACEHOLDER ENGINE — ES Module (Frontend / Mobile)
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Mirrors backend/engine/placeholder.engine.js exactly.
 * The only difference is ES Module exports instead of module.exports.
 *
 * Used by:
 ...
 *
 * Supports:
 *   {{variable}}              Simple variable substitution (HTML-escaped)
 ...
 *   {{qr_code}}               QR code placeholder div
 * ═══════════════════════════════════════════════════════════════════════════
 */
...
function resolveAttendanceTable(html, data) {
  ...
  if (!months.length) {
    return html.split("{{attendance_table}}").join(
      ...
      "No monthly attendance data available.</p>"
    );
  }
 ...
 * @param {object} data  Variable data object
 * @returns {string}     Fully rendered HTML
 */
export function resolvePlaceholders(html, data) {
 ...
 * @returns {string[]}
 */
export function scanVariables(html) {
  const found = new Set();
  const re    = /\{\{[\w\s./]+\}\}/g;
  let   match;
