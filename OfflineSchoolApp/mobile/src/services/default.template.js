// src/services/default.template.js
"use strict";
 ...
 *
 * Used when:
 *   1. A school has no custom template configured
 *   2. The ReportCard component needs to render a PDF via expo-print
 *   3. The preview screen renders without a templateId
 *
 * All {{placeholders}} are resolved by placeholder.engine.js
 * before this HTML is passed to expo-print or react-native-webview.
 *
 * Compatible placeholders:
 *   {{student_name}}      {{admission_number}}  {{class}}
 *   {{term}}              {{academic_year}}     {{gender}}
 *   {{average}}           {{grade}}             {{position}}
 *   {{total_students}}    {{remark}}            {{promotion_status}}
 *   {{school_name}}       {{school_motto}}      {{school_address}}
 *   {{principal_name}}    {{class_teacher}}
 *   {{teacher_comment}}   {{principal_comment}}
 *   {{days_present}}      {{days_absent}}       {{days_open}}
 *   {{attendance_percent}}
 *   {{next_term_date}}    {{report_date}}
 *   {{subjects_table}}    (auto-generated HTML table)
 *   {{attendance_table}}  (auto-generated HTML table)
 *   {{student_photo}}     (img tag or placeholder div)
 *   {{school_logo}}       (img tag)
 *   {{qr_code}}           (placeholder div)
 *   {{if isPassing}} ... {{else}} ... {{endif}}
 * ═══════════════════════════════════════════════════════════════════════════
 */
