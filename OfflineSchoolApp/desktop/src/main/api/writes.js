...
module.exports.push(...require("./writes/approvals"));
module.exports.push(...require("./writes/announcements"));
module.exports.push(...require("./writes/templates"));
...
module.exports.push(...require("./writes/students"));
module.exports.push(...require("./writes/staff"));
module.exports.push(...require("./writes/classes"));
module.exports.push(...require("./writes/subjects"));
module.exports.push(...require("./writes/assignments"));
module.exports.push(...require("./writes/permissions"));
module.exports.push(...require("./writes/timetable"));
